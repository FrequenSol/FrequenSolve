...
class ControlLeastSquaresProblem:
    ...
    def residual(self, model: Sequence[float]) -> np.ndarray:
    ...
    def objective(self, model: Sequence[float]) -> float:
        """Return the scalar data-plus-regularization objective."""

        return self.loss(model).total

    def jacobian(self, model: Sequence[float]) -> np.ndarray:
    ...
    def loss(self, model: Sequence[float]) -> LossTerms:
    ...
    def gradient(self, model: Sequence[float]) -> np.ndarray:
    ...
    def data_jvp(
        self, model: Sequence[float], direction: Sequence[float]
    ) -> np.ndarray:
    ...
    def data_vjp(self, model: Sequence[float], dual: Any) -> np.ndarray:
